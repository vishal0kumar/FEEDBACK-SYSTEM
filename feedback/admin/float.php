        ...
        <div class="col-md-10" style="height:700px;background-color: skyblue" >
            ...
            <div class="row" style="margin-top: 30px">
                ...
                <div class="col-md-8" style="background-color :gray;height: 200px ">
                    ...
                    <a href="../student/float.php?res=close" class="btn btn-danger text-capitalize " style="margin-left: 320px">CLOSE</a>
					<a href="../student/float.php?res=open" class="btn btn-success text-capitalize " style="margin-left: 40px">OPEN</a>
