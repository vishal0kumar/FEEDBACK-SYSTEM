    ...
    <div class="row" >
        ...
        <div class="col-md-10" style="height:700px;background-color: skyblue" >
            ...
            <div class="row" style="margin-top: 30px">
                ...
                <a class="col-md-8" style="background-color : lightgrey;height: 200px ">
                    <STRONG>ADD PROFESSOR</STRONG>
                    <form method="post" action=""  enctype="multipart/form-data">
                        UPLOAD FILE: <input type="file" class="form-control" name="file">
                        <input type="submit" name="s2" value="upload">
                    </form>
            ...
            if(isset($_POST["s2"])) {
                ...
                if ($_FILES["file"]["size"] > 0) {
                    ...
                    while (($get = fgetcsv($file, 10000, ",")) !== FALSE) {
                        ...
                        $p1=mysqli_real_escape_string($connect, $get[0]);
                        $p2=mysqli_real_escape_string($connect, $get[1]);
                        $p3=mysqli_real_escape_string($connect, $get[2]);
						$p4=mysqli_real_escape_string($connect, $get[3]);
						$p5=mysqli_real_escape_string($connect, $get[4]);
						$p6=mysqli_real_escape_string($connect, $get[6]);
						$p7=mysqli_real_escape_string($connect, $get[7]);
                        $r="INSERT INTO professsor( name, doj, email,username,course,mobile, password) VALUES ('$p1','$p2','$p3','$p4','$p5','$p6','$p7')";
