    ...
    <div class="row" >
        <div class="col-md-2 navbar-toggler-icon" id="left_sidebar" style="background-color: lightgrey">
            ...
            <a href="../professor/plogin.php" class="form-control btn btn-success" style="margin-top: 10px">PROFESSOR</a>
                        ...
                        <div class="col-md-10 " style="height:700px;background-color: lightcoral">
                            <div class="row">


                              <div style="text-align: center;height:40px;text-shadow: lightgrey;font-size: 30px;color: green;background-color: whitesmoke"><strong>ADMIN PORTAL</strong></div>
                            </div>
                            ...
                            <div class="col-md-6" style="background-color : lightgray; ">
                                  ...
                                  <form action="admin.php" method="post">
                                      <table class="table table-bordered text-capitalize">
                                          <tr></tr><tr><td>USERNAME:</td><td> <input  class="form-control" type="text" placeholder="Enter Username" name="admin_name" size="30"></td></tr>
                                          <tr></tr><tr><td>PASSWORD:</td><td> <input class="form-control" type="password" placeholder="Enter Password" name="password" size="30"> </td><tr>
                                          <tr></tr><tr></tr>
                                          <tr><td></td><td><input type="submit" name="submit1" value="LOGIN">&nbsp;
