            ...
            <div class="row" style="margin-top: 30px">
                ...
                <a class="col-md-8" style="background-color : lightgreen;height: 200px ">
                    ...
                    <form method="post" action=""  enctype="multipart/form-data">
                        ...
                        <input type="submit" name="s3" value="upload">
                    </form>
            ...
            if(isset($_POST["s3"])) {
                ...
                if ($_FILES["file"]["size"] > 0) {
                    ...
                    while (($getData = fgetcsv($file, 10000, ",")) !== FALSE) {
                        ...
                        $q1=mysqli_real_escape_string($connect, $getData[0]);
                        $q2=mysqli_real_escape_string($connect, $getData[1]);
                        
                        $r="update professsor set subject='$q2' where username='$q1'";
