            ...
            <a href="../professor/plogin.php" class="form-control btn btn-success" style="margin-top: 10px">PROFESSOR</a>
                        ...
                        <div class="col-md-10 " style="height:700px;background-color: skyblue">
                            <div class="row">
                              ...
                              <div style="text-align: center;height:40px;text-shadow: lightgrey;font-size: 30px;color: blue;background-color: whitesmoke"><strong>STUDENT PORTAL</strong></div>
                            </div>
                            ...
                            <div class="col-md-6" style="background-color : lightgreen; ">
                                  ...
                                  <form action="login.php" method="post">
                                      <table class="table table-bordered text-capitalize">
                                          <tr></tr><tr><td>USERNAME:</td><td> <input  class="form-control" type="text" placeholder="Enter Username" name="username" size="30"></td></tr>
